  ...
  return (
    <div className="min-h-screen bg-hush-green">
      ...
      <header className="mt-[30px] mx-[30px]">
        <nav className="flex justify-between items-center bg-hush-cream rounded-[300em] py-[0.2em] max-h-[60px]">
          <div className="logo font-serif text-hush-text text-[30px] ml-[2em] italic">
            <Link to="/">hush</Link>
          </div>
          <ul className="nav-links flex">
            <li className="mx-[2em]">
              <Link 
                to="/" 
                className={`text-hush-text no-underline text-[20px] mx-[2em] ${isActive('/') ? 'active' : ''}`}
              >
                Home
              </Link>
            </li>
            <li className="mx-[2em]">
              <Link 
                to="/our-story" 
                className={`text-hush-text no-underline text-[20px] mx-[2em] ${isActive('/our-story') ? 'active' : ''}`}
              >
                Our Story
              </Link>
            </li>
            <li className="mx-[2em]">
              <Link 
                to="/contact" 
                className={`text-hush-text no-underline text-[20px] mx-[2em] ${isActive('/contact') ? 'active' : ''}`}
              >
                Contact Us
              </Link>
            </li>
          ...
          <div className="cart mr-[2em]">
            <Link to="/cart">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-hush-text">
      ...
      {/* Footer */}
      <footer className="bg-hush-darkgreen text-white text-center py-4 mt-8">
